...
for tb in tb_line_streamer tb_streamer_throughput tb_sequencer tb_sequencer_loop tb_sequencer_stall tb_sequencer_long tb_sequencer_nloop tb_pmt_counter tb_pmt_timetagger tb_pmt_diff_counter; do
  echo "== run $tb =="
