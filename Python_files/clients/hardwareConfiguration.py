...
class hardwareConfiguration(object):
    ...
    ddsDict =   {
                'Raman_ax':ddsConfiguration(    0,  (0.1,380.0),   (-37.0,17.0),  350.0,   -37.0,0),
                'Raman_rad':ddsConfiguration(    2,  (0.1,380.0),   (-37.0,17.0),  350.0,   -37.0,0),
                'DDS_2':ddsConfiguration(    1,  (0.1,300.0),   (-37.0,17.0),  9,   -37.0,0),
                'DDS_3':ddsConfiguration(    3,  (0.1,300.0),   (-37.0,17.0),  39.0,   -37.0,0),
                'DDS_4':ddsConfiguration(    4,  (0.1,300.0),   (-37.0,17.0),  39.0,   -37.0,0)
                                }
    remoteChannels = {
                    }